...
/*
Rules for increasing predictability of state within the store:

1. Only one event can change the state of the store.
2. The function that returns the new state needs to be pure function.
